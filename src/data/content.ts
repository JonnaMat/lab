...
> = {
  "2603.14591": {
    ...
    engineering: {
      ...
      insight:
        "For small models, the head is a bottleneck because: (1) it cannot be quantized, (2) vocab size (~128k) is often larger than hidden state (~4k), making it a large matmul. Token prediction is retrieval, not classification—we're finding the most probable token from a corpus, not classifying into 128k classes.",
    },
  },
  "how-to-vllm-plugin": {
    ...
    related: ["flashhead-deep-dive", "https://github.com/embedl/flash-head"],
    keyPoints: [
  ...
  flashhead: {
    ...
    related: ["2603.14591", "flashhead-deep-dive", "how-to-vllm-plugin"],
    keyPoints: [
  ...
  "optimizing-vision-transformers-for-peak-performance-on-nvidia-jetson-agx-orinvidia-jetson-agx-orin":
    {
      ...
      image:
        "https://lh7-rt.googleusercontent.com/docsz/AD_4nXefT0lqOJqdusTxqfRSlDa05RPo6T3E_K9CiQtDzyv3Ue-PB3e70lCyhnxYQ0g4PdWYky6-Cd7li-EoiWEWQ0FnAHmheMXn9FAJ00cp21N46YpQZy_8-UCb_gN8YbUkqreJHTJ85GYG6R9tfUIePkM4RZpL?key=xvrY1hwx2wvGoJELuh9zZw",
      imageAlt: "Vision Transformer on NVIDIA Jetson AGX Orin",
      related: ["cosmos-reason2-report", "how-to-prune-attention"],
      keyPoints: [
...
> = {
  "embedl-flash-head": {
    description:
      "Drop-in replacement for the LM head. Up to 2× model-level inference speedup while maintaining accuracy — training-free and hardware-friendly.",
    features: [
    ...
    related: ["flashhead-deep-dive", "how-to-vllm-plugin"],
  },
  "JonnaMat-huggingface-slack-app": {
    description:
      "Custom GitHub Slack bot integration with Hugging Face. Get GitHub notifications directly in Slack with customizable alerts.",
    features: [
    ...
    mockDemo: {
      ...
      modelLinks: [
        {
          name: "embedl/gemma-3-1b-it-FlashHead-W4A16",
          downloads: 138,
          hearts: 3,
        },
        {
          name: "embedl/Qwen3-1.7B-FlashHead-W4A16",
          downloads: 105,
          hearts: 3,
        },
      ],
      codeBlock:
        "/hf subscribe embedl/gemma-3-1b-it-FlashHead-W4A16\n/hf subscribe embedl/Qwen3-1.7B-FlashHead-W4A16",
...
export const paperContent: Record<
  string,
  {
    abstract?: string[];
    related?: string[];
...
> = {
  "78958": {
    ...
    related: ["how-to-prune-attention"],
  },
};
